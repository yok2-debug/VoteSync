...
import { PlusCircle, MoreHorizontal, Edit, Trash2, Loader2, ListFilter, SlidersHorizontal } from 'lucide-react';
import {
  Table,
  TableBody,
  TableCell,
...
export default function CandidatesPage() {
  ...
  const { elections, isLoading, refreshData } = useDatabase();
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      refreshData(); // Refresh data from context
    } catch (error) {
       toast({
        variant: 'destructive',
