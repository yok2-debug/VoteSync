...
export function RealCountDisplay({ election, categories, isMain }: RealCountDisplayProps) {
        ...
        <CardContent className="flex-grow space-y-4">
           <ul className="space-y-3 text-sm">
              {candidates.map(candidate => {
                  ...
                  const percentage = liveTotalVotes > 0 ? (candidateVotes / liveTotalVotes) * 100 : 0;
                  return (
                      <li key={candidate.id}>
